...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Prediction.isPredictionVerified'
        db.alter_column(u'Api_prediction', 'isPredictionVerified', self.gf('django.db.models.fields.CharField')(max_length=50))

    def backwards(self, orm):

        # Changing field 'Prediction.isPredictionVerified'
        db.alter_column(u'Api_prediction', 'isPredictionVerified', self.gf('django.db.models.fields.BooleanField')())
