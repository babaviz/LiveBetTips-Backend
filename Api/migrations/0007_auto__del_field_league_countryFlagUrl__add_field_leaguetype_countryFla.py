...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'League.countryFlagUrl'
        db.delete_column(u'Api_league', 'countryFlagUrl')

        # Adding field 'LeagueType.countryFlagUrl'
        db.add_column(u'Api_leaguetype', 'countryFlagUrl',
                      self.gf('django.db.models.fields.files.ImageField')(default='flags/none/no-img.jpg', max_length=100),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'League.countryFlagUrl'
        db.add_column(u'Api_league', 'countryFlagUrl',
                      self.gf('django.db.models.fields.files.ImageField')(default='flags/none/no-img.jpg', max_length=100),
                      keep_default=False)

        # Deleting field 'LeagueType.countryFlagUrl'
        db.delete_column(u'Api_leaguetype', 'countryFlagUrl')
    ...
    models = {
        ...
        u'Api.gcmuser': {
            ...
            'gcmID': ('django.db.models.fields.TextField', [], {'max_length': '500'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
