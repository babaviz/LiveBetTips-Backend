...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'GcmUser.gcmID'
        db.alter_column(u'Api_gcmuser', 'gcmID', self.gf('django.db.models.fields.TextField')(max_length=500))

    def backwards(self, orm):

        # Changing field 'GcmUser.gcmID'
        db.alter_column(u'Api_gcmuser', 'gcmID', self.gf('django.db.models.fields.CharField')(max_length=300))
