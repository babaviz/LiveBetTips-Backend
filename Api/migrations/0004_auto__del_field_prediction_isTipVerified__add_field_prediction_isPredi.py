...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Prediction.isTipVerified'
        db.delete_column(u'Api_prediction', 'isTipVerified')

        # Adding field 'Prediction.isPredictionVerified'
        db.add_column(u'Api_prediction', 'isPredictionVerified',
                      self.gf('django.db.models.fields.BooleanField')(default=1),
                      keep_default=False)

        # Adding field 'Prediction.verified'
        db.add_column(u'Api_prediction', 'verified',
                      self.gf('django.db.models.fields.BooleanField')(default=0),
                      keep_default=False)

        # Adding field 'Prediction.covered'
        db.add_column(u'Api_prediction', 'covered',
                      self.gf('django.db.models.fields.BooleanField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Prediction.isTipVerified'
        db.add_column(u'Api_prediction', 'isTipVerified',
                      self.gf('django.db.models.fields.BooleanField')(default=1),
                      keep_default=False)

        # Deleting field 'Prediction.isPredictionVerified'
        db.delete_column(u'Api_prediction', 'isPredictionVerified')

        # Deleting field 'Prediction.verified'
        db.delete_column(u'Api_prediction', 'verified')

        # Deleting field 'Prediction.covered'
        db.delete_column(u'Api_prediction', 'covered')
    ...
    models = {
        ...
        u'Api.prediction': {
            ...
            'isPredictionVerified': ('django.db.models.fields.BooleanField', [], {}),
