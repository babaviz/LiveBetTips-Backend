...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Prediction.pendings'
        db.add_column(u'Api_prediction', 'pendings',
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'Prediction.pendings'
        db.delete_column(u'Api_prediction', 'pendings')
    ...
    models = {
        ...
        u'Api.prediction': {
            ...
            'pendings': ('django.db.models.fields.BooleanField', [], {}),
